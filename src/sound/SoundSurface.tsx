...
export function SoundSurface({ root, locale, source }: { root: RefObject<HTMLDivElement | null>; locale: 'ko' | 'en'; source: SoundSource }) {
  ...
  return <div className="sound-surface" data-playback={state.phase}>
    ...
    <div className="sound-static-lines" aria-hidden="true"><span /><span /></div>
