...
export const localPerformanceStudy = () => (import.meta.env.MODE === 'development-preview' || import.meta.env.MODE === 'public-site') || import.meta.env.DEV && typeof window !== 'undefined'
