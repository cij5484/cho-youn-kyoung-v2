...
import { EditorialLink } from '../home/EditorialLink.tsx'
...
/** A comparison-only adapter. The default HOME keeps its original DOM, crops and motion owner. */
export function ArtistExperience({ host, mode, locale }: ArtistExperienceProps) {
  ...
  return createPortal(<div className="artist-experience-profile" lang="ko">
