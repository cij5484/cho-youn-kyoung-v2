  ...
  return <div className="hero-shell hero-lab" data-prototype="P2E_HAEGEUM_LAB_ONLY">
    ...
    <main id="hero-main" ref={main} tabIndex={-1}>
      {isHome ? <HaegeumExperience key={location.pathname} /> : <section className="lab-destination page-frame flow">
        <p className="type-micro">P2E / navigation destination fixture</p><h1>{location.pathname}</h1>
      ...
      <section id="haegeum-end" tabIndex={-1} className="hero-review page-frame" aria-labelledby="review-title">
        <p className="type-micro label-caps">P2E / PROTOTYPE BOUNDARY</p>
        ...
        <p className="type-metadata">Final beige instrument is a user-supplied AI visual study, not a documentary photograph. Authentic macro and isolated instrument sources remain requested.</p>
      </section>
    </main>
  </div>
}
