...
export function SoundLab() {
  ...
  return <div className="hero-shell hero-lab" data-prototype="P2I_SOUND_COMPARISON_LAB_ONLY">
    ...
    <main id="sound-main" ref={main} tabIndex={-1}>
      {isHome ? <>
        <>{comparison ? <SoundComposition key={location.pathname} locale={locale} visual={visual} trail={trail} activity={activity} violet={violet} /> : <SoundExperience key={location.pathname} locale={locale} />}</>
      ...
      <footer id="sound-end" className="sound-review page-frame">
        <p className="type-micro">P2I / COMPARISON REVIEW BOUNDARY</p>
